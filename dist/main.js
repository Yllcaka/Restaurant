...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header */ \"./src/header.js\");\n/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home */ \"./src/home.js\");\n/* harmony import */ var _footer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./footer */ \"./src/footer.js\");\n/* harmony import */ var _contact__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./contact */ \"./src/contact.js\");\n/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./menu */ \"./src/menu.js\");\n\n\n\n\n\n\nconst Main = (() => {\n    let body = document.querySelector('body');\n    let mainContent = document.createElement('content');\n\n    let itemLists = [_home__WEBPACK_IMPORTED_MODULE_1__[\"Home\"].build(), _menu__WEBPACK_IMPORTED_MODULE_4__[\"Menu\"].build(), _contact__WEBPACK_IMPORTED_MODULE_3__[\"Contact\"].build()];\n\n    const init = () => {\n\n\n        _header__WEBPACK_IMPORTED_MODULE_0__[\"Header\"].navItems.forEach((item, index) => {\n            item.addEventListener('click', () => {\n                event.preventDefault();\n                let activateDOM = document.querySelector('.active');\n                activateDOM.classList.remove('active');\n\n                event.preventDefault();\n                console.log(_header__WEBPACK_IMPORTED_MODULE_0__[\"Header\"].navItems);\n                item.classList.add('active');\n                mainContent.innerHTML = \"\";\n                mainContent.appendChild(itemLists[index]);\n            });\n        });\n\n        mainContent.appendChild(_home__WEBPACK_IMPORTED_MODULE_1__[\"Home\"].build());\n        _header__WEBPACK_IMPORTED_MODULE_0__[\"Header\"].navItems[0].classList.add('active');\n        body.appendChild(_header__WEBPACK_IMPORTED_MODULE_0__[\"Header\"].build());\n        body.appendChild(mainContent);\n        body.appendChild(_footer__WEBPACK_IMPORTED_MODULE_2__[\"Footer\"].build());\n    }\n    return { init }\n})();\n\nMain.init();\n// mainContent.appendChild(Contact.contactDivDOM);\n// mainContent.appendChild(Footer.footerDOM);\n// console.log(Header.navItems);\n\n//# sourceURL=webpack:///./src/index.js?");
